    ...
    return (
        <div className="relative w-full flex flex-col justify-center items-center">
            ...
            <Swiper
                ...
                className="h-[280px] md:h-[150px] w-[270px] md:w-[550px] relative"
            >
                {serviceData.map((item, index) => (
                    <SwiperSlide key={index}>
                        <div className="flex px-6 h-auto md:h-[150px] rounded-lg cursor-pointer bg-[rgba(65,47,123,0.15)] sm:flex-col gap-x-6 sm:gap-x-0 group hover:bg-[rgba(89,65,169,0.15)] transition-all duration-300 hover:border-secondary border-2">
